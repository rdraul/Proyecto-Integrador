...
if ($_POST["nac"] == "") {
	...
	$_SESSION['contenido_mensaje_proveedor']='Debes escribir el campo antes de la Cédula';
...
if ($cedula_decimal[1]!=0){
    ...
    $_SESSION['contenido_mensaje_proveedor']='La Cédula debe ser un número entero';
    $_SESSION['proveedor_mensaje']='si';
...
// Guarda datos 
$sql="INSERT INTO tab_proveedores (cedula, nombres, apellidos, telefono, direccion, correo, comercio, fecha_reg, hora_reg, id_usuario) ";
$sql.="VALUES ('$cedula','$nombres','$apellidos','$telefono','$direccion','$correo','$comercio','$fecha_act','$hora_actual','$id_usuario_cp')";
