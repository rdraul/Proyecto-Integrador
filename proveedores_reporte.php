...
// Tabla proveedor
$sql2="SELECT * FROM tab_proveedores WHERE (id_proveedor = $id_proveedor)";
...
<meta charset="utf-8">
<title>ComputerSoft - Proveedor - Vista</title>
...
<div class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <span class="clientelabel">Cédula:</span>
    ...
    <span class="clientelabel">Comercio:</span>
    <span class="clientedato"><?php echo $row2['comercio'] ?></span>
    <br/>
  ...
  <div class="form-group">
    ...
    <a id="volver" href="Buscar_proveedores.php">Volver</a>
